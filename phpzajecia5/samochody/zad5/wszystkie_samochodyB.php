...
<head>
    ...
    <title>Wszystkie Samochody - Wariant B</title>
...
<body>
    ...
    <div class="content">
        <h1>Wszystkie samochody - Wariant B</h1>
        <table>
            <tr>
                <th>ID</th>
                <th>Marka</th>
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='samochod_info.php?id=" . $row["id"] . "'>Szczegoly</a> | <a href='index.php'>Powrot</a></td>";
                    echo "</tr>";
                }
            } else {
